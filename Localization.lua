...
local function ApplySpanish()
    ...
    L["VENDOR_EQUIPPED_TOOLTIP"] = "|TInterface\\Buttons\\UI-CheckBox-Check:14:14|t Este item ya lo tienes equipado"
    ...
    L["HELP_STATUS_EQUIPPED"] = "|cffa335eeEquipado|r %s\nUn peque¤o check verde en la esquina superior izquierda del icono indica que lo llevas puesto."
    ...
    L["SETTING_COIN_DELAY_DESC"] = "\nTiempo que se espera tras la muerte del boss antes de mostrar el recordatorio de moneda."
