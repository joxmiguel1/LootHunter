...
L["CMD_ADD_USAGE"] = "|cff00ff00[Loot Hunter]|r Usage: /lh add <itemID or itemLink>"
L["CMD_NOT_INITIALIZED"] = "|cff00ff00[Loot Hunter]|r Not yet initialized."
...
L["WON_ITEMS_CLEARED"] = "|cff00ff00[Loot Hunter] Won items cleared.|r"
...
L["STATS_LOOT_UNCOMMON"] = "Uncommon"
L["SLOT_HEADER"] = "%s"
L["CONFIRM_CLEAR_TEXT"] = "Are you sure you want to clear the entire list?"
L["CONFIRM_CLEAR_WON_TEXT"] = "Are you sure you want to remove only won items from the list?"
L["MENU_CLEAR_WON"] = "Delete won items"
L["MENU_CLEAR_ALL"] = "Delete entire list"
L["COPY_LOG_TITLE"] = "Copy Debug Log"
L["BTN_EXPORT_LOG"] = "Export Log"
L["BTN_CLEAR_LOG"] = "Clear Log"
L["BTN_DISABLE_LOGS"] = "Disable Logs"
...
L["LOG_CLEAR_CONFIRM"] = "Clear debug log?"
L["LOG_DISABLE_CONFIRM"] = "Disable debug logs? This will reload the UI."
L["FILTER_TYPE"] = "Type"
...
L["SETTING_LOGS_SECTION"] = "Logs"
L["SETTING_LOGS_ENABLE_LABEL"] = "Enable loot log"
L["SETTING_LOGS_ENABLE_DESC"] = "Stores loot/debug events and shows the Log tab. " .. ColorPrimary("(Requires /reload)")
L["SETTING_LOGS_LIMIT_LABEL"] = "Max log entries"
L["SETTING_LOGS_LIMIT_DESC"] = "When the log reaches this limit, the oldest entries are removed."
...
L["BOE_LOOTED_BY"] = "looted by"
L["BOE_OBTAINED_BY"] = "Obtained by"
L["BOE_TRASH_SOURCE"] = "Trash Mob"
L["BOE_ALERT_SETTINGS"] = "BoE Tracker"
L["SETTING_BOE_ENABLE_LABEL"] = "Enable BoE Raid Alert"
L["SETTING_BOE_ENABLE_DESC"] = "Alerts you when any Bind-on-Equip item is looted in a raid. The item and looter are logged in the active Stats session."
...
L["SETTING_STATS_HISTORY_RESET_HEADER"] = "Clear history counters"
L["SETTING_STATS_HISTORY_RESET_BUTTON"] = "Clear history counters"
L["SETTING_STATS_HISTORY_RESET_DESC"] = "Resets overall history counters (drops, wins, losses, coins, boss-no-loot) for this character. Raid sessions remain intact."
L["SETTING_STATS_HISTORY_RESET_CONFIRM"] = "This will erase your overall history counters for this character. Continue?"
L["SETTING_STATS_MAX_SESSIONS"] = "Maximum raid sessions to keep"
L["SETTING_STATS_MAX_SESSIONS_DESC"] = "How many raid sessions to store (default 25, up to 50). Oldest sessions are discarded when the limit is exceeded."
...
L["STATS_ANNOUNCE_GUILD_WALL"] = "|TInterface\\TargetingFrame\\UI-RaidTargetingIcon_8:14|t WALL OF SHAME |TInterface\\TargetingFrame\\UI-RaidTargetingIcon_8:14|t"
...
L["STATS_WALL_CHANNEL_PROMPT"] = "Where do you want to announce the Wall of Shame?"
L["STATS_WALL_SESSION_LABEL"] = "Session: %s"
L["STATS_WALL_CHANNEL_LOCAL"] = "Only to me"
L["STATS_WALL_CHANNEL_GUILD"] = "Guild"
L["STATS_WALL_CHANNEL_RAID"] = "Raid"
L["STATS_WALL_BTN"] = "Wall of Shame"
...
L["SETTING_MISC_AUTO_REMOVE_LABEL"] = "Auto-remove won items from list"
L["SETTING_MISC_AUTO_REMOVE_DESC"] = "Automatically remove items from your watch list when you win them."
...
local function ApplySpanish()
    ...
    L["CMD_ADD_USAGE"] = "|cff00ff00[Loot Hunter]|r Uso: /lh add <itemID o itemLink>"
    L["CMD_NOT_INITIALIZED"] = "|cff00ff00[Loot Hunter]|r Aún no inicializado."
    ...
    L["WON_ITEMS_CLEARED"] = "|cff00ff00[Loot Hunter] Items ganados eliminados.|r"
    ...
    L["EMPTY_HELP_HINT"] = "¿Necesitas ayuda? Abre la guía del usuario."
    ...
    L["TAB_HELP"] = "Ayuda"
    L["STATS_PLACEHOLDER"] = "Las estadísticas llegan pronto. Aquí verás tus drops, ganados y progreso de prioridad."
    ...
    L["STATS_LOOT_UNCOMMON"] = "Poco común"
    L["SLOT_HEADER"] = "%s"
    L["CONFIRM_CLEAR_TEXT"] = "¿Estás seguro de que quieres borrar toda la lista?"
    L["CONFIRM_CLEAR_WON_TEXT"] = "¿Estás seguro de que quieres eliminar solo los ítems ganados de la lista?"
    L["MENU_CLEAR_WON"] = "Eliminar ganados"
    L["MENU_CLEAR_ALL"] = "Eliminar toda la lista"
    L["COPY_LOG_TITLE"] = "Copiar log de debug"
    L["BTN_EXPORT_LOG"] = "Exportar log"
    L["BTN_CLEAR_LOG"] = "Borrar log"
    L["BTN_DISABLE_LOGS"] = "Deshabilitar logs"
    ...
    L["LOG_CLEAR_CONFIRM"] = "¿Borrar el log de depuración?"
    L["LOG_DISABLE_CONFIRM"] = "¿Deshabilitar logs? Esto hará /reload."
    L["FILTER_TYPE"] = "Tipo"
    ...
    L["BOE_LOOTED_BY"] = "obtenido por"
    L["BOE_OBTAINED_BY"] = "Obtenido por"
    L["BOE_TRASH_SOURCE"] = "Trash Mob"
    L["BOE_ALERT_SETTINGS"] = "Rastreador de BoE"
    L["SETTING_BOE_ENABLE_LABEL"] = "Activar alerta de BoE en banda"
    L["SETTING_BOE_ENABLE_DESC"] = "Te avisa cuando cualquier objeto BoE es looteado en una raid. El ítem y el looteador quedan registrados en la sesión activa de Stats."
    ...
    L["SETTING_STATS_HISTORY_RESET_HEADER"] = "Borrar contadores del historial"
    L["SETTING_STATS_HISTORY_RESET_BUTTON"] = "Borrar contadores del historial"
    L["SETTING_STATS_HISTORY_RESET_DESC"] = "Reinicia los contadores generales (drops, ganados, perdidos, monedas, jefes sin loot) para este personaje. Las sesiones se conservan."
    L["SETTING_STATS_HISTORY_RESET_CONFIRM"] = "Esto borrará los contadores generales de este personaje. ¿Continuar?"
    L["SETTING_STATS_MAX_SESSIONS"] = "Máximo de raids a guardar"
    L["SETTING_STATS_MAX_SESSIONS_DESC"] = "Sesiones de raid a almacenar (por defecto 25, máximo 50). Las más antiguas se eliminan al superar el límite."
    L["STATS_ANNOUNCE_GUILD_TOOLTIP"] = "Anunciar en la hermandad"
    L["STATS_ANNOUNCE_GUILD_HEADER"] = "--- Loot Hunters! ---"
    L["STATS_ANNOUNCE_GUILD_DATE"] = "[- %s - %s -]"
    L["STATS_ANNOUNCE_GUILD_WALL"] = "|TInterface\\TargetingFrame\\UI-RaidTargetingIcon_8:14|t MURO DE LA VERGÜENZA |TInterface\\TargetingFrame\\UI-RaidTargetingIcon_8:14|t"
    L["STATS_WALL_DEATHS"] = "Más muertes - %s (%s)"
    ...
    L["STATS_WALL_CHANNEL_PROMPT"] = "¿Dónde quieres anunciar el Muro de la Vergüenza?"
    L["STATS_WALL_SESSION_LABEL"] = "Sesión: %s"
    L["STATS_WALL_CHANNEL_LOCAL"] = "Solo para mí"
    L["STATS_WALL_CHANNEL_GUILD"] = "Hermandad"
    L["STATS_WALL_CHANNEL_RAID"] = "Raid"
    L["STATS_WALL_BTN"] = "Muro de la Vergüenza"
    L["DE_ANNOUNCE_EN"] = "[Loot Hunter] ¡%s ha sido desencantado!"
    L["DE_ANNOUNCE_ES"] = "[Loot Hunter] ¡%s ha sido desencantado!"
    L["CREDITS_HEADING"] = ""
    L["CREDITS_DESC"] = "Este proyecto no sería posible sin el apoyo constante,\nconsejos y QA de Arkaboy.\n¡Gracias!\n\nUn enorme agradecimiento a cada miembro de\nWilds for the Night por probar el addon y ayudar a\nhacer este proyecto una realidad."
    L["CREDITS_GUILD_TITLE"] = "Wilds for the Night [WftN]"
    ...
    L["SETTING_LOGS_SECTION"] = "Registro"
    L["SETTING_LOGS_ENABLE_LABEL"] = "Guardar registro de loot"
    L["SETTING_LOGS_ENABLE_DESC"] = "Guarda eventos de loot/depuración y muestra la pestaña Log. " .. ColorPrimary("(Requiere /reload)")
    L["SETTING_LOGS_LIMIT_LABEL"] = "Límite de entradas"
    L["SETTING_LOGS_LIMIT_DESC"] = "Cuando el registro alcance el límite, se eliminan las entradas más antiguas."
    ...
    L["SETTING_MISC_AUTO_REMOVE_LABEL"] = "Eliminar automáticamente items ganados de la lista"
    L["SETTING_MISC_AUTO_REMOVE_DESC"] = "Elimina automáticamente los items de tu lista de seguimiento cuando los ganas."
