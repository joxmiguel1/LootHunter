...
L["LOADING"] = "Loading..."
L["CONGRATS_RAID_MSG"] = " CONGRATS! TRACKED LOOT SECURED! "
L["CONGRATS_CHAT_MSG"] = "|cff00ff00[Loot Hunter] Congrats! You received: %s|r"
L["DROP_RAID_MSG"] = "%s %s %s\n%s"
L["DROP_LABEL"] = "DROP!"
...
L["CONGRATS_ALERT_TITLE"] = "Congrats! GG!"
L["CONGRATS_ALERT_DESC"] = "You've won your item"
L["DROP_CHAT_MSG"] = ColorPrimary("[Loot Hunter] Attention! Dropped: %s Don't forget to roll!!")
...
L["COIN_REMINDER_NONE"] = ColorPrimary("[Loot Hunter] No coin reminders pending.")
L["COIN_REMINDER_BTN_TOOLTIP"] = "Trigger the coin reminder message."
...
L["EMPTY_TITLE"] = CreateGradient("Conquer the Mist", 0.208, 0.498, 0.09, 0.729, 0.925, 0.255)
L["EMPTY_QUOTES"] = {
    "\"Don't let your rewards hide from you.\"",
}
L["EMPTY_INSTRUCTIONS"] = "|cff00ff00Tip:|r Open the Dungeon Journal and |cffffffffShift+Click|r any item you want to track."
L["EMPTY_CTA_INSTRUCTION"] = "Pandaria's treasures are hidden in the mist.\nConsult the Dungeon Journal |cff89e433(Shift+J)|r\nand mark your item |cff89e433(Shift+Click)|r to secure your reward."
...
L["WORK_QUOTE"] = "\"Me busy, leave me alone!\" - Orc Peon"
L["SLOT_HEADER"] = "%s"
...
L["HELP_BUGS_DESC"] = "If you find a bug, please share steps to reproduce, item links, and screenshots if possible."
L["HELP_CREDITS_TITLE"] = "Credits"
L["SPEC_TOOLTIP"] = "Click to change spec."
L["TIER_TOKEN_SOURCE"] = "Tier token"
L["TIER_TOKEN_FOR"] = "Tier token for %s%s"
...
L["SETTING_LANGUAGE_LABEL"] = "Language"
...
L["SETTING_LANGUAGE_RELOAD"] = "[Loot Hunter] Language updated. Reload the UI (/reload) to apply."
...
local function ApplySpanish()
    ...
    L["LOADING"] = "Cargando..."
    L["CONGRATS_RAID_MSG"] = " ¡FELICIDADES! ¡TU BOTÍN RASTREADO LLEGÓ! "
    L["CONGRATS_CHAT_MSG"] = "|cff00ff00[Loot Hunter] ¡Felicidades! Has conseguido: %s|r"
    L["DROP_RAID_MSG"] = "%s %s %s\n%s"
    L["DROP_LABEL"] = "¡ATENCIÓN! DROP!"
    L["DROP_CHAT_MSG"] = ColorPrimary("[Loot Hunter] ¡Atención! Ha salido: %s. ¡No olvides tirar dados!")
    ...
    L["CONGRATS_ALERT_TITLE"] = "¡Felicidades! ¡GG!"
    L["CONGRATS_ALERT_DESC"] = "Has ganado tu botín"
    ...
    L["COIN_REMINDER_NONE"] = ColorPrimary("[Loot Hunter] No hay recordatorios de moneda pendientes.")
    L["COIN_REMINDER_BTN_TOOLTIP"] = "Dispara manualmente el aviso de la moneda."
    ...
    L["COIN_REMINDER_PREVIEW"] = "Jefe de prueba"
    L["BTN_TEXT"] = "Loot Hunter"
    L["WINDOW_TITLE"] = "Loot Hunter - %s"
    L["EMPTY_TITLE"] = CreateGradient("Conquista a la niebla", 0.208, 0.498, 0.09, 0.729, 0.925, 0.255)
    L["EMPTY_QUOTES"] = {
        "\"No dejes que tus recompensas se oculten de ti.\"",
    }
    L["EMPTY_INSTRUCTIONS"] = "|cff00ff00Consejo:|r Abre la Guía de calabozos y usa |cffffffffShift+Click|r en cualquier objeto que quieras rastrear."
    L["EMPTY_CTA_INSTRUCTION"] = "Los tesoros de Pandaria están ocultos en la niebla.\nConsulta la Guía de calabozos |cff89e433(Shift+J)|r\ny marca tu ítem |cff89e433(Shift+Click)|r para asegurar tu recompensa."
    ...
    L["WORK_QUOTE"] = "\"¡Estoy ocupado, déjame en paz!\" - Peón orco"
    L["SLOT_HEADER"] = "%s"
    L["SPEC_DESTRUCTION"] = "Destrucción"
    ...
    L["HELP_STATUS_INTRO"] = "Las señales visuales (bordes/checks) muestran el estado más reciente de la lista; solo uno se enseña a la vez para mantener la lista clara.\n\n"
    L["HELP_BUGS_TITLE"] = "Reporte de Bugs"
    L["HELP_BUGS_DESC"] = "Si encuentras un bug, comparte pasos para reproducirlo, links de ítems y capturas si es posible."
    L["HELP_CREDITS_TITLE"] = "Créditos"
    L["SPEC_TOOLTIP"] = "Haz clic para cambiar la spec."
    L["TIER_TOKEN_SOURCE"] = "Token de tier"
    L["TIER_TOKEN_FOR"] = "Token de tier para %s%s"
    ...
    L["SETTING_COIN_PREWARN_DESC"] = "Recordatorio personal + sonido sutil 3 segundos despues de que muere el boss (con la ventana de moneda visible)."
    ...
    L["SETTING_GENERAL_SCALE_DESC"] = "Ajusta el tamano general de Loot Hunter."
    ...
    L["SETTING_LANGUAGE_LABEL"] = "Idioma"
    ...
    L["SETTING_LANGUAGE_RELOAD"] = "[Loot Hunter] Idioma actualizado. Recarga la interfaz (/reload) para aplicar."
