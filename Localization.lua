...
L["HELP_STATUS_WON"] = ColorPrimary("Won (list status)") .. "\nPrimary-colored row border + green text show the item was already obtained."
...
L["CREDITS"] = "|cffffffffMade with love by|r\n|cff8764e8[WftN] Xamael|r"
L["TAB_LIST"] = "My List"
L["TAB_HELP"] = "Help"
L["SLOT_HEADER"] = "%s"
...
L["CREDITS_HEADING"] = "Acknowledgements"
L["CREDITS_DESC"] = "This project wouldn’t be possible without the unconditional\nsupport and QA from Arkaboy. Thank you!\n\nHuge thanks to every member of Wilds for the Night who\ntested the addon and donated time to make what you see now."
L["CREDITS_GUILD_TITLE"] = "Wilds for the Night [WftN]"
L["CREDITS_FAREWELL"] = "From the abyss, Xamael"
...
local function ApplySpanish()
    ...
    L["HELP_STATUS_WON"] = ColorPrimary("Conseguido (estado de lista)") .. "\nBorde en color primario + texto verde muestran que ya lo conseguiste."
    ...
    L["SETTING_ALERTS_BOSS_NONE_DESC"] = "Muestra un mensaje en el chat cuando muere un jefe que no tiene ítems de tu lista."
    L["CREDITS_HEADING"] = "Agradecimientos"
    L["CREDITS_DESC"] = "Este proyecto no hubiera sido posible sin el apoyo incondicional y QA de Arkaboy, ¡gracias!\n\nGracias a todos los integrantes de Wilds for the Night que testearon el addon y me regalaron tiempo para mejorar lo que ves ahora."
    L["CREDITS_GUILD_TITLE"] = "Wilds for the Night [WftN]"
    L["CREDITS_FAREWELL"] = "Desde el abismo, Xamael"
